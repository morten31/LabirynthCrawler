...
public class NormalAttackVisitor(Player player) : IAttackVisitor
{
    ...
    public (int Damage, int Defense) Visit(HeavyWeapon weapon) => (weapon.Damage, _attr.Power + _attr.Luck);
    public (int Damage, int Defense) Visit(LightWeapon weapon) => (weapon.Damage, _attr.Agility + _attr.Luck);
...
public class StealthAttackVisitor(Player player) : IAttackVisitor
{
    ...
    public (int Damage, int Defense) Visit(HeavyWeapon weapon) => (weapon.Damage / 2, _attr.Power);
    public (int Damage, int Defense) Visit(LightWeapon weapon) => (weapon.Damage * 2, _attr.Agility);
...
public class MagicAttackVisitor(Player player) : IAttackVisitor
{
    ...
    public (int Damage, int Defense) Visit(MagicWeapon weapon) => (weapon.Damage, _attr.Wisdom * 2);
